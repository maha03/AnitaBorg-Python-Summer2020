...
#             constraints given. The input does not accept strings and floating point numbers.The program displays
#             the digits by mathematical operations and not by iterating the number as a python string.
