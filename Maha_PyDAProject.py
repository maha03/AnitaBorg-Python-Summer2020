...
Wolfram Alpha computational engine and Wikipedia page articles.
PyDA returns the answer in both text and speech format. The speech format is implemented using pyttsx3 library.
Right now, the voice is female. In future version, I plan to develop PyDA with voice being user choice
